...
Yo! 🙋
So there I was in my native, Devakottai, Tamil Nadu.

<img src="/assets/native-temple.png" alt="" style="float: right; width: 35%; max-width: 300px; min-width: 140px; shape-outside: url('/assets/native-temple.png'); shape-margin: 0.75rem; shape-image-threshold: 0.1;" />
...
<img src="/assets/native-card.png" alt="" style="float: left; width: 50%; max-width: 250px; min-width: 120px; shape-outside: url('/assets/native-card.png'); shape-margin: 0.5rem; shape-image-threshold: 0.1;" />
...
<img src="/assets/native-temple-fest.png" alt="" style="float: left; width: 35%; max-width: 250px; min-width: 140px; shape-outside: url('/assets/native-temple-fest.png'); shape-margin: 0.75rem; shape-image-threshold: 0.1;" />
