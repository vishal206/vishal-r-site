...
const AboutSection: React.FC<AboutSectionProps> = ({ onClose }) => {
  ...
  const socialLinks = [
    { icon: faLinkedin, label: "LinkedIn", url: "https://linkedin.com/in/vishal-r-profile" },
    { icon: faSquareGithub, label: "GitHub", url: "https://github.com/vishal206" },
      ...
      <div className=" mx-auto">
        ...
        <div className="grid grid-cols-12 md:grid-rows-12 grid-rows-14 md:gap-6 gap-2 md:h-[95vh] h-[130vh]">
          ...
          <div className="col-start-1 md:col-end-6 col-end-13 md:row-start-1 row-start-2 md:row-end-13 row-end-6">
            <div className={`bg-background-secondary rounded-lg p-6 h-full overflow-y-auto`}>
              <h1 className="md:text-3xl font-serif text-gray-800 md:mb-4">About Me</h1>
          ...
          <div className="md:col-start-6 col-start-1 md:col-end-11 col-end-11 md:row-start-1 row-start-1 md:row-end-3 row-end-2">
            <div className={`bg-background-grid-section rounded-lg h-full flex items-center justify-center`}>
          ...
          {/* Close Button Box */}
          <div className={`md:col-start-11 col-start-11 col-end-13 md:row-start-1 md:row-end-3 row-start-1 row-end-2 flex justify-center items-center bg-background-tertiary rounded-lg`}>
            <button
              onClick={onClose}
              className={`text-text-primary w-full p-2 rounded-lg cursor-pointer`}
            >
              <FontAwesomeIcon icon={faHome}  className="md:text-3xl text-base hover:text-4xl"/>
            </button>
          </div>
